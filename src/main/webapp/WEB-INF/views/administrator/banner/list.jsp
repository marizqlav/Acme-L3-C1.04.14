...
<acme:list>
	...
	<acme:list-column code="administrator.banner.list.label.displayPeriodFirstDate" path="displayPeriodFirstDate"/>
	<acme:list-column code="administrator.banner.list.label.displayPeriodLastDate" path="displayPeriodLastDate"/>
	...
	<acme:list-column code="administrator.banner.list.label.linkWeb" path="linkWeb"/>
</acme:list>
