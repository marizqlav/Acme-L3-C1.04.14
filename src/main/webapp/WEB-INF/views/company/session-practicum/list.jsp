...
<acme:button test="${showCreate && !draftMode}" code="company.session-practicum.list.button.createAddendum" action="/company/session-practicum/create?practicumId=${practicumId}"/>